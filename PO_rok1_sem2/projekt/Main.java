...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            while (true) {
                System.out.println("WYBIERZ:\n1 - pokaz napoje\n2 - wplac monety\n3 - kupno\n?? - lista transakcji\n0 - wyjdz\n?? - panel administracyjny/dodawanie asortymentu");
                ...
                switch (choice) {
                    ...
                    case 2115:
                        System.out.print("podaj kod dostępu administratora:(122) ");
                        int key = inputInt();
                        if (key == 122) {
                            System.out.println("prawidłowy kod dostępu");
                            ...
                            System.out.println("podałes nieprawidlowy klucz, nie jestes adminem");
                            break;
                        }
                    ...
                    case 4:
                        ...
                        if (key2 == 122) {
                            ...
                            System.out.println("podałes nieprawidłowy klucz, nie jestes adminem");
                            break;
                        }
